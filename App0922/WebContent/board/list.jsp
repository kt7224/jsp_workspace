...
<%
	...
	out.print(list.size()+"건의 게시물이 조회됬었용");
%>
		...
		<td colspan="5" id="list">
		  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		    ...
		    <tr align="center" height="20px" onMouseOver="this.style.background='#FFFF99'" onMouseOut="this.style.background=''">
			  <td width="50"><%=i+1 %></td>
			  <td width="303"><a href="detail.jsp?board_id=<%=list.get(i).getBoard_id()%>"><%=list.get(i).getTitle() %></a></td>
			  <td width="100"><%=list.get(i).getWriter() %></td>
			  <td width="100"><%=list.get(i).getRegdate().substring(0, 10) %></td>
