...
<table width="1070px" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="970px">
			...
			<%
				List<SubCategory> subList=subCategoryDAO.selectAll(top_id);
			%>			
			<!--top content end -->
		</td>
		...
		<div id="content">
			<div id="left">
				<table border="1px" width="200px">
				  ...
				  <tr>
					  <td>
					  	<a <%if(sub_id == subDTO.getSub_id()){%>class="active"<%}%>  href="list.jsp?top_id=<%=top_id%>&sub_id=<%=subDTO.getSub_id()%>"><%=subDTO.getTitle() %></a>
					  </td>
				  </tr>
				  <%}%>
				</table>			
			...
			<div id="section">
					...
					<div id="productBox">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
	                        <tr>
	                          <td>
	                          <a  href="/shopping/detail.jsp">
	                          	<img src="/product/<%=product.getProduct_id()%>.<%=FileManager.getExt(product.getImg()) %>" width="120" height="120" />
	                          </a>
	                          </td>
	                        ...
	                        <tr>
	                          <td><img src="/images/shirt/sale_img.gif" width="28" height="11" /><%=product.getProduct_name() %> <br />
	                            &lt;<%=product.getGender() %>&gt;<%=product.getColor() %><br />
