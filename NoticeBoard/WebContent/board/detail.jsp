...
<%
	...
	Notice dto=dao.selectOne(Integer.parseInt(request.getParameter("notice_id")));
...
function remove(){
	if (confirm("삭제하시겠습니까?")) {
		location.href="/board/delete.jsp?notice_id=<%=dto.getNotice_id()%>";
	}
}
</script>
</head>
...
<table id="box" align="center" width="603" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>	
		<td id="list"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr id="content">
            ...
            <td><textarea id="area" name="content" style=""><%=dto.getContent() %></textarea>
  ...
  <tr>
	...
	<img src="/board/images/delete_btn.gif" width="61" height="20" onClick="remove()"> <a href="/board/list.jsp"><img src="/board/images/list_btn.gif" width="61" height="20" border="0"></a> </td>
  </tr>
  <tr>
    <td height="1" bgcolor="#CCCCCC"></td>
  </tr>
